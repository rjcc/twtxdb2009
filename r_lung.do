...
insheet using "/Users/apple/Documents/rjcc2/txdb2009/r_lung.csv", clear
...
quietly log using r_lung, smcl replace
...
*     Op: op_type right_lung left_lung
...
*     Pulm outcome: boop bron_stenosis bron_stent
*     Donor: dnr_id_no
*     Lab: fev chase_date
...
sts graph, ytitle(Proportion of Survival) ///
    ...
    risktable censored(single) saving(km_lung_die, replace) ///
    xtitle(Month) xlabel(0 (12) 168) gwood ///
    title ("Lung: Kaplan-Meier Survival Curve")
graph export km_lung_die.pdf, replace
sts list, at (1 (12) 168)

quietly log close
quietly log2html r_lung, replace erase linesize(255)
